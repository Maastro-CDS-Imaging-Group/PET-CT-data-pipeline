...
class Preprocessor():
    ...
    def __init__(self,
                 ...
                 normalization_method={'PET': 'clip-and-rescale', 'CT': 'clip-and-rescale'},
        ...
        for key in ['PET', 'CT']:
            if normalization_method[key] == 'histogram-mapping':
                self.landmarks_dict[key] = np.loadtxt(histogram_landmarks_path[key])
